...
$config['message_start_delimiter'] = '<div class="alert alert-success alert-dismissible fade show" role="alert"><strong>';		// Message start delimiter
$config['message_end_delimiter']   = '</strong><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';	// Error message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>';		// Message start delimiter
$config['error_end_delimiter']     = '</strong><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';	// Error message end delimiter
